  ...
  return (
    <section id="home" className="hero-about-section">
      <div className="hero-about-container">
        {/* Single-column centered layout like al-folio */}
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            PhD Student in Wastewater-Based Epidemiology
          </p>
          <p className="hero-affiliation">
            <a href="https://gtu.ac.in/" target="_blank" rel="noopener noreferrer">Gujarat Technology University</a> · <a href="https://gbrc.gujarat.gov.in/" target="_blank" rel="noopener noreferrer">GBRC</a>
          </p>

          {/* Social links - centered */}
          <div className="hero-social-links">
            <a href="mailto:nitinshukla1912@gmail.com" className="social-icon" title="Email">
        ...
        {/* About section - separate block with left-aligned text */}
